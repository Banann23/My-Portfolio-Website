    ...
    return (
        <>
            ...
            <div className={styles.projectCards}>
                <ProjectCard projectType="Front-end" projectTitle={t("projectTitle1")} projectTechstack="React, CSS, JavaScript, Framer Motion" projectDesc={t("projectDesc1")} projectLink="https://github.com/Banann23/My-Portfolio-Website" projectLinkIcon="/sprite.svg#icon-github" projectLinkSpan={t("projectLinkSpan1")} />
